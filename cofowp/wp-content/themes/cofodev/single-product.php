...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		while ( have_posts() ) : the_post();
			...
			$hello = "https://cofodesign-com.myshopify.com/admin/oauth/authorize?client_id=" . $apiKey . "&scope=read_checkouts&redirect_uri={redirect_uri}&state={nonce}&grant_options[]={option}";
