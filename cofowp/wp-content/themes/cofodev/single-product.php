					...
					<div class="social anm-container">
						...
						<div class="social-nav">
							<ul>
								...
								<li class="anm-item slideright-item"><a class="social-share" href="http://pinterest.com/pin/create/button/?url=<?php echo $url ?>&description=<?php echo urlencode(get_post_meta($post->ID, '_yoast_wpseo_metadesc', true)); ?>"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
								...
								<li class="anm-item slideright-item"><a class="social-share" href="https://twitter.com/intent/tweet?text=<?php echo urlencode(get_post_meta($post->ID, '_yoast_wpseo_metadesc', true)); ?>" data-size="large" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
